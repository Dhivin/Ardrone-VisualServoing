...
class ARdroneDriver(object):
   def __init__(self):
      ...
      # start controller loop to send periodic commands to the ARdrone
      self.commandTimer = rospy.Timer(rospy.Duration(1.0/COMMAND_FRQ),self.sendCommand)
